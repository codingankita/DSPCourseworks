...
% Input parameters:
% N: the number of the FIR filter taps. Note: It must be an odd number.
% Ftype: the filter type. 1=Lowpass, 2=Highpass, 3=Bandpass, 4=Band reject
% WnL: lower cutoff frequency in radians/sample. Set WnL=0 for the highpass filter.
% WnH: upper cutoff frequency in radians/sample. Set WnH=0 for the lowpass filter.
% Wtypw: window type: 1=Rectangular, 2=Triangular, 3=Hanning, 4=Hamming, 5=Blackman
% Output:
